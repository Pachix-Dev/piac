  ...
  return (
    ...
    >
      ...
      <p className='text-lg md:text-2xl pb-3 mb-8 text-right text-amber-300 border-b-2 border-gray-800'>
        {currentLanguage === 'es'
          ? 'Agenda 2025, sujeta a cambios***'
          : 'Agenda 2025, subject to change***'}
      </p>
      <ul className='list-none p-0'>
        {agenda2025.map((mainEvent) => (
          <li
            key={mainEvent.id}
            className='mb-6 bg-white shadow-lg rounded-xl overflow-hidden'
          >
            <button
            ...
            {expandedMainEventId === mainEvent.id && (
              <div className='p-6 transition-all duration-300 ease-in-out text-xl'>
                ...
                <div>
                  <h3 class='uppercase font-bold text-2xl pt-4 border-t-2 border-gray-200'>
                    {currentLanguage === 'es'
                      ? 'Beneficios para el PIAC:'
                      : 'Benefits for PIAC   :'}
                  </h3>
                  <p
                    dangerouslySetInnerHTML={{
                      __html:
                        currentLanguage === 'es'
                          ? mainEvent.beneficios
                          : mainEvent.beneficios_en,
                    }}
